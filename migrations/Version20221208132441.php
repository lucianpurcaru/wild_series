 ...
 */
final class Version20221208132441 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE episode ADD duration INT NOT NULL, ADD slug VARCHAR(255) NOT NULL, CHANGE synopsis synopsis LONGTEXT NOT NULL');
        $this->addSql('ALTER TABLE program ADD country VARCHAR(255) NOT NULL, ADD year INT NOT NULL, ADD slug VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE episode DROP duration, DROP slug, CHANGE synopsis synopsis LONGTEXT DEFAULT NULL');
        $this->addSql('DROP INDEX UNIQ_92ED77842B36786B ON program');
        $this->addSql('ALTER TABLE program DROP country, DROP year, DROP slug');
    }
}
